...
// Dastlabki namunaviy ma'lumotlar (Seed Data)
const initialData = {
  tables: [
  ...
  orders: [
    ...
    },
    {
      ...
      waiterName: "Jasur",
      items: [
        { menuItemId: 1, name: "To'y Oshi (Maxsus)", quantity: 4, price: 45000, costPrice: 24000, note: "" },
        { menuItemId: 11, name: "Go'shtli Tandir Somsa", quantity: 4, price: 12000, costPrice: 6500, note: "" },
        { menuItemId: 12, name: "Ko'k Choy (Limon va Asalli)", quantity: 2, price: 12000, costPrice: 3000, note: "" }
      ],
      subtotal: 252000,
      serviceChargeRate: 10,
      serviceChargeAmount: 25200,
      discountRate: 10,
      ...
      closedAt: new Date(Date.now() - 180 * 60 * 1000).toISOString()
    }
  ],
  settings: {
...
// DB yuklash yoki dastlabki holatni yozish
export const loadDb = () => {
  try {
